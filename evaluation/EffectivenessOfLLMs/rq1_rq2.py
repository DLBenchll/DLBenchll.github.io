...
if __name__ == "__main__":
    ...
    # test_suites_extension_schema_to_str("test-suites-extension-postgresql")
    # test_suites_extension_process("test-suites-extension-postgresql")
    # test_suites_extension_rq1_rq2_exp("test-suites-extension-postgresql")
